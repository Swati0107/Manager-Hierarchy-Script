...
def create_level_mapping(user_level_dict):
...
def start_process():
    ...
    input_path='managers_hierarchy_api/sample_input/sample_dataset.json'
    
    # Read Sample Output Json Path
    output_path="managers_hierarchy_api/sample_output/sample_output.csv"
    ...
    try:
        ...
        level_dict=create_level_mapping(user_level_mapping)
